...
function App() {
    ...
    return (
        <div className="w-full h-full bg-slate-900">
            ...
            {
                hostArr.map((host, i) =>
                    <div key={i} className="flex flex-col px-16 my-8">
                        <div className="h-16 bg-neutral-20 font-bold text-white text-5xl">
                            {host.hostname}
                        </div>
                        <div className="rounded bg-neutral-200 dark:bg-neutral-600">
                            <div className={(host.onCooldown ? "bg-red-600" : "bg-green-500") + " h-2 rounded"} style={{ width: host.barPercent }}></div>
                        </div>
                        <div className="bg-neutral-20 font-bold text-white text-3xl">
